...
def _validate_authoritative_domain_state(domain: Any, authoritative_state: Mapping[str, Any], replay: bool) -> None:
    ...
    instance_keys = {"booking_id", "vehicle_id", "vehicle_version", "provider_id", "provider_name", "provider_email", "out_date", "expected_return_date", "status", "returned_at", "cancelled_at", "returned_by", "cancelled_by", "notes", "source_kind", "source_ref", "source_evidence", "version", "created_at", "created_by", "updated_at", "updated_by"}

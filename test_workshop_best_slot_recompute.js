...
assert.match(recompute, /workshopBestStageSlot\(normalizedStage, windowStart, estimate, workshopLoadPlans\(\), notBeforeMinutes, windowEnd, vehicleWindows, pmbBayMechanic\(vehicle\) \|\| '', null, null, vehicle\)/);

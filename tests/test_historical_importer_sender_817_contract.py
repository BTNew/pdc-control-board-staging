...
MIGRATION = ROOT / "supabase/staging_only/20260830238000_817_historical_importer_sender_binding_final_successor.sql"


class HistoricalImporterSender817ContractTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_append_only_814_predecessor_and_parse(self):
        ...
        for marker in (
            ...
            "pdc_817_current_head_or_importer_prestate_failed",
            "pdc_817_historical_importer_sender_postcondition_failed",
        ):

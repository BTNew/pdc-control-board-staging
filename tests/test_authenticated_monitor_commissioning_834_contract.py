...
MIGRATION = ROOT / "supabase/staging_only/20260830255000_834_authenticated_monitor_commissioning_reactivation.sql"


class AuthenticatedMonitorCommissioning834ContractTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_append_only_current_head_guard_and_parse(self):
        ...
        for marker in (
            "20260830254000",
            "833_historical_operation_hours_correction_successor",
            "20260830255000",
            "834_authenticated_monitor_commissioning_reactivation",
            "pdc_834_exact_833_commissioning_prestate_failed",
            "pdc_834_authenticated_monitor_commissioning_reactivation_postcondition_failed",
        ):
    ...
    def test_security_and_containment(self):
        for marker in (
            ...
            "revoke all on public.pdc_email_monitor_authenticated_mailbox_reactivation_history_834",
            "not task_enabled",
    ...
    def test_immutable_history_and_no_task_enablement(self):
        ...
        self.assertIn("pdc_834_authenticated_mailbox_reactivation_history_immutable", self.lower)

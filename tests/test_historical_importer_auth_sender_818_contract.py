...
MIGRATION = ROOT / "supabase/staging_only/20260830239000_818_historical_importer_auth_sender_successor.sql"


class HistoricalImporterAuthSender818ContractTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_append_only_817_predecessor_and_parse(self):
        ...
        for marker in (
            ...
            "20260830239000",
            "818_historical_importer_auth_sender_successor",
            "pdc_818_current_head_or_importer_prestate_failed",
            "pdc_818_historical_importer_auth_sender_postcondition_failed",
        ):
            self.assertIn(marker.lower(), self.lower)

    def test_only_historical_authorization_sender_argument_changes(self):
    ...
    def test_security_and_normal_contract_remain(self):
        for marker in (

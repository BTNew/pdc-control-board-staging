...
MIGRATION = ROOT / "supabase/staging_only/20260831290000_863_exact_retry_after_storage_repair.sql"


class ExactRetryAfterStorageRepair863ContractTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
    ...
    def test_exact_861_predecessor_and_parse(self):
        ...
        for marker in (
            "20260831280000",
            "pdc_checklist_completion_booking_preservation",
            "20260831290000",
            "863_exact_retry_after_storage_repair",
            "pdc_863_exact_current_requeue_prestate_failed",
            "pdc_863_exact_requeue_postcondition_failed",
        ):
    ...
    def test_security_and_monitor_controls_remain_fail_closed(self):
        for marker in (
            ...
            "revoke all on public.pdc_monitor_exact_requeue_history_863",
            "not task_enabled",

...
class RuntimeRotationReplayMigrationTests(unittest.TestCase):
    ...
    def test_fourteen_immutable_complete_evidence_fixtures_are_exposed_by_rpc_only(self):
        ...
        self.assertIn("t.source_receipt_id=(p_plan->>'source_receipt_id')::uuid", attestation)
        self.assertIn("t.source_digest=lower(p_plan->>'source_digest')", attestation)
        self.assertIn("t.evidence_digest=lower(p_plan->>'evidence_digest')", attestation)

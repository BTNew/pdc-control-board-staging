...
assert(!candidateHydration.includes('...(local || {})') && candidateHydration.includes("client: raw.customer_name || ''"), 'Control Board canonical hydration may expose only the approved authoritative customer name, never local customer or note aliases');

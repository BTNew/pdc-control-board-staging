...
assert.match(app, /const APP_VERSION = '2026\.08\.27\.08-navision-linked-vehicle-refresh'/);
assert.match(index, /app\.js\?v=2026\.08\.27\.08-navision-linked-vehicle-refresh/);

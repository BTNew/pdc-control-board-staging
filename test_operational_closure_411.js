...
assert.match(app, /const APP_VERSION = '2026\.08\.26\.04-operational-closure'/);
assert.match(index, /app\.js\?v=2026\.08\.26\.04-operational-closure/);
...
assert.match(app, /const refreshed = vehicleModalBoundVehicle\(\)/);

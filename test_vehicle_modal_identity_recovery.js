...
function testRecoveryAndRetryIntegrationContracts() {
  ...
  assert(index.includes('vehicle-modal-identity.js?v=2026.08.29.760-refresh-click'));
  assert(index.includes('vehicle-locations-refresh=2026.08.29.760-refresh-click'));

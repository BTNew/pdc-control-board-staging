...
assert.strictEqual(identity.application_version, '2026.08.27.12-all-jobcard-operations-visible');
assert.strictEqual(identity.observed_applied_database_migration.version, '20260827042000');

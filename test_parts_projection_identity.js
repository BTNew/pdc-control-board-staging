...
assert.ok(action.includes('service.markPartsOrdered(vehicleId, expectedVersion, crypto.randomUUID())'), 'Mark Ordered uses the resolved canonical id/version plus a fresh idempotency key');

...
(async()=>{
 let handlers=null,fetches=0,renders=0;
 const app={workshopEligibilityRealtime:null,workshopEligibilitySnapshot:{stale:true},workshopEligibilityState:'connected',workshopEligibilityError:'',workshopEligibilityRequestGeneration:0,currentView:'workflow'};
 ...
 app.workshopEligibilitySnapshot={stale:true}; handlers.onClosed(); assert.strictEqual(app.workshopEligibilitySnapshot,null); assert.strictEqual(app.workshopEligibilityState,'reconnecting');

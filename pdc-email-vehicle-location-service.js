...
function mapServerVehicle(row = {}) {
  ...
  mapped.__navisionDetailsSource = String(row.details_source || '').trim().toLowerCase();
  mapped.__navisionDetailsBackendRecordId = String(row.details_backend_record_id || '').trim();
  mapped.__navisionDetailsIdentityConflict = mapped.__navisionDetailsSource === 'identity_review';

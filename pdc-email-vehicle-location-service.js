...
function createPdcEmailVehicleLocationService(options = {}) {
  ...
  return { authority: 'supabase_staging_authenticated_email_vehicle', snapshot, updateSublet, updatePartsEta, markPartsOrdered, subscribe };
}
const exported = { PDC_EMAIL_VEHICLE_STAGING_PROJECT_REF, PDC_EMAIL_VEHICLE_REVISION_TABLE, PDC_EMAIL_VEHICLE_SNAPSHOT_RPC, PDC_SUBLET_UPDATE_RPC, PDC_PARTS_ETA_UPDATE_RPC, PDC_PARTS_ORDERED_RPC, canonicalWorkKey, mapServerVehicle, reconcileVehicleRows, createPdcEmailVehicleLocationService };

...
Authoritative private release: `https://github.com/BTNew/pdc-email-ai-successor-recovery/releases/tag/pdc-email-ai-recovery-pack-v1.8`
...
The private v1.8 release also carries `pdc-monitor-staging-m502-2026.08.69.tar.gz`, the 3,351-file secretless transport asset required for clean-room Windows installation.

...
console.log(JSON.stringify({vehicles:500,work_items:1000,bookings:500,planners:stationCodes.length,evaluations,elapsed_ms:Number(elapsed.toFixed(2)),heap_delta_bytes:heapDelta,sublet_rejected:true,pit_inspection_enabled:false}));

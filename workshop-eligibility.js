...
(function initWorkshopEligibility(root, factory) {
  ...
  const STATIONS = Object.freeze([
    ...
    Object.freeze({ code: 'PIT_INSPECTION', label: 'Pit', short: 'PI', workKey: 'PITINSPECTION', jobKey: 'pitInspection', route: '', path: '', plannerEnabled: false, statusVisible: true, aliases: ['PIT_INSPECTION', 'PITINSPECTION', 'PIT INSPECTION', 'PIT', 'PITS', 'INSPECTION'] }),

...
|---|---|---|---|---|
| R-001 | High | QC phone workflow requires wide horizontal matrix navigation. | `styles.css:11179-11200`, `styles.css:11349-11359`; error-prone identifier/state/action association. | WD-001; Craig decisions CD-001/002/007. |
...
| R-003 | High | Inconsistent dialog focus containment/return. | Vehicle modal focuses Close but close does not restore opener (`app.js:12040-12098`); only specialist link dialog has full trap. | WD-003. |
...
| R-005 | Medium | Touch targets are too small in sampled mobile UI. | 32–34px filters/buttons observed at 375px; planner admin controls 32px. | WD-005. |

...
| Add operations | Not represented by 225 plan-item actions (`edit`, `delete`, `move`). | Add an append action with server-generated stable operation identity, bounded required fields, source/instruction evidence and idempotent reservation. |

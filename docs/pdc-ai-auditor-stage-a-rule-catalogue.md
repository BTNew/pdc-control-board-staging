...
Catalogue version: `stage-a-rule-catalogue-v2`
Rule count: **60**
...
### 6. DUPLICATE_OPERATION_LINE_ID — Duplicate operation-line identity

- **Authoritative inputs:** operationLines.id
- **Exact trigger:** More than one operation line has the same non-empty canonical ID.
- **Exclusions:** Rows outside dealer scope, closed or inapplicable states, and absent non-authoritative evidence do not satisfy the trigger.
- **Severity:** critical
- **Risk component / points:** authority; 25 × finding confidence, capped in authority
- **Confidence:** 1.0
- **Recommendation:** Reconcile duplicate authenticated operation-line identities.
- **Stable dedupe identity:** dealer + rule + operation-line ID
- **Resolution:** Operation-line ID is unique.
- **Limitations:** Only authoritative snapshot fields are used; absent evidence is not inferred.

### 7. OPERATION_LINE_AUTHORITY_INVALID — Operation-line authority invalid

- **Authoritative inputs:** operationLine.id/dealer/vehicleId
- **Exact trigger:** An authenticated operation line lacks a required canonical identity or authority field.
- **Exclusions:** Rows outside dealer scope, closed or inapplicable states, and absent non-authoritative evidence do not satisfy the trigger.
- **Severity:** critical
- **Risk component / points:** authority; 25 × finding confidence, capped in authority
- **Confidence:** 1.0
- **Recommendation:** Quarantine the line until canonical operation-line authority is restored.
- **Stable dedupe identity:** dealer + rule + operation-line row
- **Resolution:** Every authenticated operation line carries canonical identity and dealer/vehicle authority.
- **Limitations:** Only authoritative snapshot fields are used; absent evidence is not inferred.

### 8. DUPLICATE_BOOKING_ID — Duplicate booking identity
...
### 9. BOOKING_AUTHORITY_INVALID — Booking authority invalid
...
### 10. BOOKING_VEHICLE_UNRESOLVED — Booking vehicle unresolved
...
### 11. BOOKING_INTERVAL_INVALID — Booking interval invalid
...
### 12. BOOKING_WITHOUT_ACTIVE_CANONICAL_WORK — Booking without active canonical work
...
### 13. WORK_MULTIPLE_ACTIVE_BOOKINGS — Work with multiple active bookings
...
### 14. DUPLICATE_ACTIVE_BOOKING — Duplicate active booking
...
### 15. COMPLETED_INACTIVE_WORK_BOOKED — Completed or inactive work booked
...
### 16. VEHICLE_OVERLAP — Vehicle booking overlap
...
### 17. BAY_OVERLAP — Bay booking overlap
...
### 18. TECHNICIAN_OVERLAP — Technician booking overlap
...
### 19. STATION_INCOMPATIBLE — Incompatible station
...
### 20. STATION_COMPATIBILITY_UNKNOWN — Unknown station compatibility
...
### 21. APPROVED_PARALLEL_COMPATIBLE_WORK — Approved parallel-compatible work
...
### 22. BOOKING_OUTSIDE_HOURS — Booking outside hours
...
### 23. LABOUR_HOURS_MISSING — Labour hours missing
...
### 24. LABOUR_HOURS_ZERO — Labour hours zero
...
### 25. LABOUR_HOURS_NEGATIVE — Labour hours negative
...
### 26. LABOUR_PROVENANCE_MISSING — Labour provenance missing
...
### 27. OPERATION_LINE_HOURS_MISSING — Operation-line estimated hours missing

- **Authoritative inputs:** operationLine.estimatedHours
- **Exact trigger:** An authenticated operation line has no explicit numeric estimated-hour value in its immutable source evidence.
- **Exclusions:** Rows outside dealer scope, closed or inapplicable states, and absent non-authoritative evidence do not satisfy the trigger.
- **Severity:** medium
- **Risk component / points:** hours; 8 × finding confidence, capped in hours
- **Confidence:** 1.0
- **Recommendation:** Review the source evidence and, when supported, record a separate audited Workshop overlay.
- **Stable dedupe identity:** dealer + rule + operation-line ID
- **Resolution:** The authenticated source carries an explicit estimate or the finding is dispositioned with an audited limitation.
- **Limitations:** This reports immutable source evidence only; it never edits or assumes an overlay.

### 28. OPERATION_LINE_HOURS_NEGATIVE — Operation-line estimated hours negative

- **Authoritative inputs:** operationLine.estimatedHours
- **Exact trigger:** An authenticated operation line has a numeric estimated-hour value below zero.
- **Exclusions:** Rows outside dealer scope, closed or inapplicable states, and absent non-authoritative evidence do not satisfy the trigger.
- **Severity:** high
- **Risk component / points:** hours; 15 × finding confidence, capped in hours
- **Confidence:** 1.0
- **Recommendation:** Quarantine the invalid estimate and review the source evidence.
- **Stable dedupe identity:** dealer + rule + operation-line ID
- **Resolution:** The source value is non-negative.
- **Limitations:** This reports immutable source evidence only; it never repairs the value.

### 29. OPERATION_LINE_HOURS_PROVENANCE_UNKNOWN — Operation-line hour provenance unknown

- **Authoritative inputs:** operationLine.hoursProvenance
- **Exact trigger:** An authenticated operation line with a numeric estimate has no confirmed job-card or AI-estimate provenance.
- **Exclusions:** Rows outside dealer scope, closed or inapplicable states, and absent non-authoritative evidence do not satisfy the trigger.
- **Severity:** medium
- **Risk component / points:** hours; 8 × finding confidence, capped in hours
- **Confidence:** 1.0
- **Recommendation:** Review and record the estimate provenance outside the immutable source row.
- **Stable dedupe identity:** dealer + rule + operation-line ID
- **Resolution:** A recognized provenance is present.
- **Limitations:** Unknown provenance is not promoted to confirmed evidence.

### 30. OPERATION_LINE_STAGE_MISSING — Operation-line station missing

- **Authoritative inputs:** operationLine.workKey
- **Exact trigger:** An authenticated operation line has no canonical work/station key.
- **Exclusions:** Rows outside dealer scope, closed or inapplicable states, and absent non-authoritative evidence do not satisfy the trigger.
- **Severity:** high
- **Risk component / points:** workflow; 15 × finding confidence, capped in workflow
- **Confidence:** 1.0
- **Recommendation:** Review the line and route it through a separate audited Workshop overlay.
- **Stable dedupe identity:** dealer + rule + operation-line ID
- **Resolution:** A canonical work/station key is present.
- **Limitations:** The Auditor does not guess a station from free text.

### 31. BOOKING_DURATION_TOO_SHORT — Booking duration too short
...
### 32. BOOKING_DURATION_TOO_LONG — Booking duration too long
...
### 33. BOOKING_DURATION_MISMATCH — Duration differs from estimate
...
### 34. PARTS_CONFIDENCE_LIMIT — Parts relation confidence limit
...
### 35. PARTS_REQUIRED_TODAY — Parts required today
...
### 36. PARTS_NOT_CONFIRMED_ONE_WORKING_DAY — Parts not confirmed after one working day
...
### 37. PARTS_ORDERED_OR_UNKNOWN_THREE_WORKING_DAYS — Parts ordered or unknown after three working days
...
### 38. PARTS_ACTIVE_STOPPAGE_BOOKED_OR_STARTED — Parts stoppage booked or started
...
### 39. PARTS_RECEIVED_WITH_STOPPAGE — Parts received with stoppage
...
### 40. PARTS_READY_NO_FUTURE_BOOKING — Parts ready without future booking
...
### 41. FORGOTTEN_WORK — Forgotten work
...
### 42. CANCELLED_NO_REPLACEMENT — Cancelled booking without replacement
...
### 43. NEXT_DEPARTMENT_UNPLANNED — Next department unplanned
...
### 45. STALE_STOPPAGE — Stale stoppage
...
### 46. QC_NOT_RFT — QC complete but not RFT
...
### 47. RFT_NOT_COLLECTED — RFT not collected
...
### 48. IT_AT_ETA_NO_PLAN — IT at ETA with no plan
...
### 49. YH_READY_NOT_REVIEWED — YH ready not reviewed
...
### 50. WORK_STOPPAGE — Work stoppage
...
### 51. BOOKING_STOPPAGE — Booking stoppage
...
### 52. STOPPAGE_DETAILS_INCOMPLETE — Stoppage governance incomplete
...
### 53. WORKFLOW_SEQUENCE_INVALID — Workflow predecessor incomplete
...
### 54. WORKFLOW_STATUS_INVALID — Work status invalid
...
### 55. BOOKING_STATUS_INVALID — Booking status invalid
...
### 56. STARTED_WORK_WITHOUT_STARTED_BOOKING — Started work without started booking
...
### 57. COMPLETED_WORK_MISSING_EVIDENCE — Completed work missing evidence
...
### 58. CANCELLED_WORK_MISSING_REASON — Cancelled work missing reason
...
### 59. FUTURE_BOOKING_MARKED_STARTED — Future booking marked started
...
### 60. SUBLET_PLANNER_FORBIDDEN — Sublet in internal planner

...
assert.match(css, /#parts \.parts-queue-table \{ width: 100%; min-width: 0; table-layout: fixed; \}/);
assert.match(css, /#parts \.parts-queue-table th:nth-child\(6\), #parts \.parts-queue-table td:nth-child\(6\) \{ width: 5% !important; \}/);
...
assert.match(app, /<th>Parts status<\/th><th>JITA<\/th><th>Outstanding station work<\/th><th>Stoppage reason<\/th><th>Actions<\/th>/);

...
assert.match(css, /#parts \.parts-queue-table \{ width: 100%; min-width: 1320px; table-layout: fixed; \}/);
assert.match(css, /#parts \.parts-queue-table th:nth-child\(6\), #parts \.parts-queue-table td:nth-child\(6\) \{ width: 10% !important; \}/);
...
assert.match(desktopCss, /\.parts-queue-table \{[\s\S]*?min-width: 1320px;/);
...
assert.match(app, /<th>Parts status<\/th><th>Parts ETA<\/th><th>ETA counter<\/th><th>JITA<\/th><th>Parts STOPPAGE reason<\/th><th>Actions<\/th>/);

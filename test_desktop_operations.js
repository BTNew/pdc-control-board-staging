...
assert.ok(app.includes("const APP_VERSION = '2026.07.14.18-collapsed-intake-rows';"));
...
for (const file of htmlFiles) {
  ...
  assert.ok(html.includes('desktop-operations.css?v=2026.07.14.18-collapsed-intake-rows'), `${file} is missing the desktop stylesheet`);

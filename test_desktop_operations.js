...
assert.ok(app.includes("const APP_VERSION = '2026.07.18.01-stage2a-final-contained';"));
...
for (const file of htmlFiles) {
  ...
  assert.ok(html.includes('desktop-operations.css?v=2026.07.18.01-stage2a-final-contained'), `${file} is missing the desktop stylesheet`);

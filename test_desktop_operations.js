...
assert.ok(app.includes("const APP_VERSION = '2026.07.14.02-email-board-sync';"));
...
for (const file of htmlFiles) {
  ...
  assert.ok(html.includes('desktop-operations.css?v=2026.07.14.02-email-board-sync'), `${file} is missing the desktop stylesheet`);

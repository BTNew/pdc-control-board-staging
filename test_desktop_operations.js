...
assert.ok(app.includes("const APP_VERSION = '2026.07.13.08-navision-po-visibility';"));
...
assert.ok(app.includes("'Master sheet' : 'Navision only'"));
...
for (const file of htmlFiles) {
  ...
  assert.ok(html.includes('desktop-operations.css?v=2026.07.13.08-navision-po-visibility'), `${file} is missing the desktop stylesheet`);

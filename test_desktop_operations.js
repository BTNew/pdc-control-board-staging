...
assert.ok(app.includes("const APP_VERSION = '2026.07.17.08-stage2a-reconcile-on-reconnect';"));
...
for (const file of htmlFiles) {
  ...
  assert.ok(html.includes('desktop-operations.css?v=2026.07.17.08-stage2a-reconcile-on-reconnect'), `${file} is missing the desktop stylesheet`);

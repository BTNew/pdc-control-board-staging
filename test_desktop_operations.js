...
assert.ok(app.includes("const APP_VERSION = '2026.07.14.08-stage1-staff-feedback';"));
...
for (const file of htmlFiles) {
  ...
  assert.ok(html.includes('desktop-operations.css?v=2026.07.14.08-stage1-staff-feedback'), `${file} is missing the desktop stylesheet`);

...
assert.ok(app.includes("const APP_VERSION = '2026.07.14.12-workshop-weekly-safe';"));
...
for (const file of htmlFiles) {
  ...
  assert.ok(html.includes('desktop-operations.css?v=2026.07.14.12-workshop-weekly-safe'), `${file} is missing the desktop stylesheet`);

...
assert.ok(app.includes("const APP_VERSION = '2026.07.15.03-control-board-planner-links';"));
...
for (const file of htmlFiles) {
  ...
  assert.ok(html.includes('desktop-operations.css?v=2026.07.15.03-control-board-planner-links'), `${file} is missing the desktop stylesheet`);

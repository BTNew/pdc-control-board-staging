...
assert.ok(app.includes("const APP_VERSION = '2026.07.20.01-shared-navision-backend-store';"));
...
for (const file of htmlFiles) {
  ...
  assert.ok(html.includes('desktop-operations.css?v=2026.07.20.01-shared-navision-backend-store'), `${file} is missing the desktop stylesheet`);

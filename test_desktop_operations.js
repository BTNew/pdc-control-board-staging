...
assert.ok(app.includes("const APP_VERSION = '2026.07.15.01-audit-correctness-performance';"));
...
for (const file of htmlFiles) {
  ...
  assert.ok(html.includes('desktop-operations.css?v=2026.07.15.01-audit-correctness-performance'), `${file} is missing the desktop stylesheet`);

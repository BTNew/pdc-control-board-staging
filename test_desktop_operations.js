...
assert.ok(app.includes("const APP_VERSION = '2026.07.14.10-workshop-planner-stage2';"));
...
for (const file of htmlFiles) {
  ...
  assert.ok(html.includes('desktop-operations.css?v=2026.07.14.10-workshop-planner-stage2'), `${file} is missing the desktop stylesheet`);

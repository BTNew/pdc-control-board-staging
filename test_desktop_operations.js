...
assert.ok(app.includes("const APP_VERSION = '2026.07.14.05-multi-email-jobs';"));
...
for (const file of htmlFiles) {
  ...
  assert.ok(html.includes('desktop-operations.css?v=2026.07.14.05-multi-email-jobs'), `${file} is missing the desktop stylesheet`);

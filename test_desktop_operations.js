...
assert.ok(app.includes("const APP_VERSION = '2026.07.16.25-workshop-drop-followup';"));
...
for (const file of htmlFiles) {
  ...
  assert.ok(html.includes('desktop-operations.css?v=2026.07.16.25-workshop-drop-followup'), `${file} is missing the desktop stylesheet`);

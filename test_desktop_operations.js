...
assert.ok(app.includes("const APP_VERSION = '2026.07.16.19-workshop-planner-ux';"));
...
for (const file of htmlFiles) {
  ...
  assert.ok(html.includes('desktop-operations.css?v=2026.07.16.19-workshop-planner-ux'), `${file} is missing the desktop stylesheet`);

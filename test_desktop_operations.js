...
assert.ok(app.includes("const APP_VERSION = '2026.07.16.24-workshop-drop-fix';"));
...
for (const file of htmlFiles) {
  ...
  assert.ok(html.includes('desktop-operations.css?v=2026.07.16.24-workshop-drop-fix'), `${file} is missing the desktop stylesheet`);

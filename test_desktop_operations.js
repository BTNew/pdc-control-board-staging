...
assert.ok(app.includes("const APP_VERSION = '2026.07.15.17-ai-file-assistant-phase1';"));
...
for (const file of htmlFiles) {
  ...
  assert.ok(html.includes('desktop-operations.css?v=2026.07.15.17-ai-file-assistant-phase1'), `${file} is missing the desktop stylesheet`);

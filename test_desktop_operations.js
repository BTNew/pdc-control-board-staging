...
assert.ok(app.includes("const APP_VERSION = '2026.07.13.21-autocare-pmb';"));
...
for (const file of htmlFiles) {
  ...
  assert.ok(html.includes('desktop-operations.css?v=2026.07.13.21-autocare-pmb'), `${file} is missing the desktop stylesheet`);

...
assert.ok(app.includes("const APP_VERSION = '2026.07.15.12-mechanic-roster';"));
...
for (const file of htmlFiles) {
  ...
  assert.ok(html.includes('desktop-operations.css?v=2026.07.15.12-mechanic-roster'), `${file} is missing the desktop stylesheet`);

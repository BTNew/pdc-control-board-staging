...
assert.ok(app.includes("const APP_VERSION = '2026.07.15.10-parts-current-location';"));
...
for (const file of htmlFiles) {
  ...
  assert.ok(html.includes('desktop-operations.css?v=2026.07.15.10-parts-current-location'), `${file} is missing the desktop stylesheet`);

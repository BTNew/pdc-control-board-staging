...
assert.ok(app.includes("const APP_VERSION = '2026.07.14.09-stage2-staff-automation';"));
...
for (const file of htmlFiles) {
  ...
  assert.ok(html.includes('desktop-operations.css?v=2026.07.14.09-stage2-staff-automation'), `${file} is missing the desktop stylesheet`);

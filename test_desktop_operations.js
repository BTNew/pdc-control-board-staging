...
assert.ok(app.includes("const APP_VERSION = '2026.07.16.27-workshop-realtime';"));
...
for (const file of htmlFiles) {
  ...
  assert.ok(html.includes('desktop-operations.css?v=2026.07.16.27-workshop-realtime'), `${file} is missing the desktop stylesheet`);

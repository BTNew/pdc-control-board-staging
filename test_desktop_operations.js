...
assert.ok(app.includes("const APP_VERSION = '2026.07.15.08-parts-warning-policy';"));
...
for (const file of htmlFiles) {
  ...
  assert.ok(html.includes('desktop-operations.css?v=2026.07.15.08-parts-warning-policy'), `${file} is missing the desktop stylesheet`);

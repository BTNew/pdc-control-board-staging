...
assert.ok(app.includes("const APP_VERSION = '2026.07.15.05-password-auth';"));
...
for (const file of htmlFiles) {
  ...
  assert.ok(html.includes('desktop-operations.css?v=2026.07.15.05-password-auth'), `${file} is missing the desktop stylesheet`);

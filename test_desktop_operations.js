...
assert.ok(app.includes("const APP_VERSION = '2026.07.14.14-workshop-hard-block-overlaps';"));
...
for (const file of htmlFiles) {
  ...
  assert.ok(html.includes('desktop-operations.css?v=2026.07.14.14-workshop-hard-block-overlaps'), `${file} is missing the desktop stylesheet`);

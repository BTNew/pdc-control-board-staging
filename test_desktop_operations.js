...
assert.ok(app.includes("const APP_VERSION = '2026.07.15.11-back-to-back-drop';"));
...
for (const file of htmlFiles) {
  ...
  assert.ok(html.includes('desktop-operations.css?v=2026.07.15.11-back-to-back-drop'), `${file} is missing the desktop stylesheet`);

...
assert.ok(app.includes("const APP_VERSION = '2026.07.17.02-backup-system';"));
...
for (const file of htmlFiles) {
  ...
  assert.ok(html.includes('desktop-operations.css?v=2026.07.17.02-backup-system'), `${file} is missing the desktop stylesheet`);

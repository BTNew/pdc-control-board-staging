...
assert.ok(app.includes("const APP_VERSION = '2026.07.16.21-workshop-hide-sublet';"));
...
for (const file of htmlFiles) {
  ...
  assert.ok(html.includes('desktop-operations.css?v=2026.07.16.21-workshop-hide-sublet'), `${file} is missing the desktop stylesheet`);

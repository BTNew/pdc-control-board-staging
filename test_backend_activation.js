...
assert.ok(html.includes('Stock, order, VIN, customer, vehicle or job card'), 'Back End Data search must describe supported identities');
...
assert.ok(css.includes('Back End Data — 9 explicit columns'), 'Back End Data action column styling is missing');

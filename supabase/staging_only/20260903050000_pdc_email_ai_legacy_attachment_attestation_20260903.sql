...
SELECT pg_advisory_xact_lock(hashtextextended('pdc-staging-20260903050000-email-ai-success-evidence-immutability',0));
...
BEGIN
  ...
  IF current_user<>'postgres' OR session_user<>'postgres'
     ...
     OR v_head<>'20260903040000'
     OR (SELECT count(*) FROM supabase_migrations.schema_migrations WHERE version='20260903040000' AND name='pdc_email_ai_legacy_success_evidence_immutability_20260903')<>1
     OR EXISTS(SELECT 1 FROM supabase_migrations.schema_migrations WHERE version='20260903050000')
  THEN RAISE EXCEPTION 'PDC_20260903050000_STAGING_PRECONDITION_FAILED' USING errcode='55000'; END IF;
END $guard$;
...
BEGIN
  ...
  THEN RAISE EXCEPTION 'PDC_20260903050000_POSTCONDITION_FAILED' USING errcode='55000'; END IF;
END $post$;

INSERT INTO supabase_migrations.schema_migrations(version,name,statements) VALUES(
 '20260903050000','pdc_email_ai_legacy_attachment_attestation_20260903',ARRAY[

-- Staging-only migration 241: remove ambiguous PL/pgSQL booking variable in Undo.
begin;
...
as $fn$
declare r public.workshop_booking_move_receipts%rowtype; x jsonb; v_booking public.workshop_bookings%rowtype; v_email text;
begin
...
values('241','workshop_admin_undo_ambiguous_booking_fix',array['rename Undo booking row variable to avoid ambiguity with SQL aliases'])

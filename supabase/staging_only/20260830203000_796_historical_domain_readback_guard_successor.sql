...
BEGIN
 FOR r IN SELECT * FROM (VALUES
   ...
   ('public.pdc_historical_job_card_attachments_immutable_782()','fa3c8b3fdef6daa59362e20ef54f1597199ab61acae087dd40c0d562bd852355','search_path=pg_catalog, public','postgres:EXECUTE:false','pdc_782_jobcard_evidence_immutable') AS x(sig,body_hash,config,acl,callee) LOOP

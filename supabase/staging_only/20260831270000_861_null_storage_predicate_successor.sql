-- STAGING ONLY 861: correct NULL storage-path classification after 860.
-- Convert quarantined attachment paths into an
...
SELECT pg_advisory_xact_lock(hashtextextended('pdc-monitor-staging-861-null-storage-predicate',0));
...
BEGIN
 ...
 IF encode(extensions.digest(convert_to(v,'UTF8'),'sha256'),'hex') IS DISTINCT FROM 'ae491dc5553f93a15cd2e1535bab4bbf7d13b3d7871150af20605b006164d480'
 ...
 THEN RAISE EXCEPTION 'PDC_861_NULL_STORAGE_POSTCONDITION_FAILED' USING errcode='55000'; END IF;
END
$post$;

INSERT INTO supabase_migrations.schema_migrations(version,name,statements) VALUES('20260831270000','861_null_storage_predicate_successor',ARRAY[

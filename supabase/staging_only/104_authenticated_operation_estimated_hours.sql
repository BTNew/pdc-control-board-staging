-- Staging-only migration 104: explicit estimated hours for authenticated job-card operation lines.
-- Adds missing OP lines and write-once hour evidence; never books or completes work or Parts.
begin;
  ...
  for v_item in select value from jsonb_array_elements(v_operations) loop
    ...
    if v_line_before.operation_line_id is null then
      ...
      values('insert','pdc_authenticated_email_operation_lines',v_line_after.operation_line_id,v_receipt.vehicle_id,v_actor_id,v_actor_email,null,
        ...
        jsonb_build_object('source','pdc_authenticated_email_operation_hours_104','source_hash',v_source_hash,'no_booking',true));
      ...
      values('update','pdc_authenticated_email_operation_lines',v_line_after.operation_line_id,v_receipt.vehicle_id,v_actor_id,v_actor_email,
        ...
        jsonb_build_object('source','pdc_authenticated_email_operation_hours_104','source_hash',v_source_hash,

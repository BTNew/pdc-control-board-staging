...
BEGIN
 ...
 SELECT v.version_id,x.alias FROM (VALUES
  ...
  ('12v_socket_plug_electrical','12v acc socket'),('12v_socket_plug_electrical','12v accessory socket'),('12v_socket_plug_electrical','12v plug'),
...
BEGIN
 ...
 WHERE f.family_key IN('towbars_fitting','fire_extinguishers_fitting','12v_socket_plug_electrical','battery_box_bcdc_electrical','xrs370c_electrical','navman_cardex_electrical')

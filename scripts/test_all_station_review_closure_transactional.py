...
try:
 ...
 print(json.dumps({'migration_043_transactional':True,'yh_without_eta_scheduled':True,'location_stage_visibility_unchanged':True,'importer_snapshot_schedule_and_direct_booking_denied':True,'alias_parity':sum(map(len,ALIASES.values())),'config_revision_bumped':True,'rolled_back':True}))
finally:

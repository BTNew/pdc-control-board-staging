...
def main() -> int:
    ...
    manifest.update({
        ...
        "successor_patch": {
            ...
            "source_path": "backend/imap_bridge_successor_20260863.py",
            "sha256": sha(bridge),
            "contract": "HTTP 400 body code KeyAlreadyExists and statusCode 409 only",
        },
        "successor_processor": {
            "path": "backend/email_intake_processor.py",
            "source_path": "backend/email_intake_processor_successor_20260863.py",
        ...
        "successor_jobcard_client": {
            ...
            "source_path": "backend/pdc_jobcard_runtime_client_successor_20260863.py",
            "sha256": sha(jobcard),

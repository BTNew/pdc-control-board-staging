#!/usr/bin/env python3
"""Apply guarded PDC-14 replay-fixture cleanup support to STAGING only."""
...
MIGRATION=ROOT/'supabase/staging_only/20260904011200_pdc14_location_replay_fixture_cleanup.sql'
APPROVAL='PDC_APPROVE_STAGING_MIGRATION_20260904011200'
TARGET=['20260904011200','pdc14_location_replay_fixture_cleanup']
def state():

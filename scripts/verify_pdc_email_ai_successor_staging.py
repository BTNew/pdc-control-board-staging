...
def main() -> None:
    ...
    try:
        ...
        result["ok"] = result["ok"] and result["command_rpc_present"] and result["health_rpc_present"] and result["typed_action_surface_present"] and result["typed_action_contract_present"] and result["strict_wrapper_full_validator_bound"] and result["authenticated_command_execute"] and not result["service_role_command_execute"] and not result["production_sentinel_present"]

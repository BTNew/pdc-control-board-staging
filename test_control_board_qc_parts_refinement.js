...
assert(styles.includes('#parts .parts-queue-row > td { height: var(--pdc-row-height);'), 'Parts row height must use the same shared row-height variable as Vehicle Locations');

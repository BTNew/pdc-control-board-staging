(() => {
  ...
  const load = () => {
    ...
    intakeStyle.href = 'pdc-new-vehicles.css?v=2026.09.12.review-orange-match&review-fixes=2026.09.13.01&operation-approval=2026.09.14.01';
    document.head.appendChild(intakeStyle);
    const intakeScript = document.createElement('script');
    intakeScript.src = 'pdc-new-vehicles.js?v=2026.09.13.render-performance&ai-estimates=2026.09.14.01&review-fixes=2026.09.13.01&operation-approval=2026.09.14.01&deep-review=2026.09.13.01';
    intakeScript.onload = () => {

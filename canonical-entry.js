(() => {
  ...
  const load = () => {
    ...
    intakeScript.src = 'pdc-new-vehicles.js?v=2026.09.13.render-performance&ai-estimates=2026.09.14.01&review-fixes=2026.09.13.01&operation-approval=2026.09.13.02&deep-review=2026.09.13.01';
    intakeScript.onload = () => {
